...
# video_dir = '/bigdata/SurgPose/000028/regular/left_frames' # For SurgPose
video_dir = '/home/zijianwu/Downloads/STIR_SAM_Demo/22seq13' # For Ethan
...
points = np.array([[103, 124], [339, 244], [209, 312]], dtype=np.float32) #np.array([[1223, 542], [1204, 537], [1221, 513], [1253, 542], [1221, 555]], dtype=np.float32)
...
# with open("./keypoints/keypoints_000029_right_psm3.yaml", "w") as f: 
#     yaml.dump(video_keypoints, f)

breakpoint()

# render the segmentation results every few frames
# video_dir = '/bigdata/SurgPose/000000/regular/left_frames'
vis_frame_stride = 1
